...
@section('content')
    ...
    <form action="/produk-stok/{{ $stok->id }}" method="post">
        ...
        <input type="text" name="NamaProduk" id="NamaProduk" class="form-control w-50" value="{{ $stok->NamaProduk }}"
            readonly>
    ...
    <style>
        ...
        input[readonly] {
            ...
            /* Use any background color you prefer */
            border: 1px solid #ced4da;
            /* Add a border to visually differentiate it */
        }
    </style>
